...
hl.animation({ leaf = "windows", enabled = true, speed = 2.5, spring = "macSpring" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 2.5, spring = "macSpring", style = "popin 85%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 2.4, bezier = "snappyOut", style = "popin 88%" })
hl.animation({ leaf = "windowsMove", enabled = true, speed = 2.0, spring = "macSpring" })
...
hl.animation({ leaf = "workspaces", enabled = true, speed = 2.5, spring = "macSoftSpring", style = "slidefade 18%" })
